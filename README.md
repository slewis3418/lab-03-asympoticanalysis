...
In this lab, you will be presented with problems that will allow you to hone your understanding of Aymptotic Analysis and build an intuition regarding the relative growth rates of common functions.

To complete this lab, follow the instructions in [lab-03.md](lab-03.md) ([PDF version](lab-03.pdf)). Below you'll find important and useful information about submitting your work, using git, and testing your code. 
